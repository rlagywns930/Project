...
| `06. 모델링.md`                  | XGBoost 모델링, 튜닝, 평가                      |
| `07. 최종 제출 파일.md`          | 예측 결과 저장 및 `submission.csv` 생성         |
| `08. 최종 해석 및 분석.md`       | 모델 해석 및 향후 개선 방향 정리                 |
...
3. `06. 모델링.md` → XGBoost 모델 학습 및 평가  
4. `07. 최종 제출 파일.md` → `submission.csv` 생성  
5. `08. 최종 해석 및 분석.md` → 결과 해석 및 개선 방향 제시  
